 ...
 * 
 */
package presentacion.empleado.mostrarEmpleado;
...
public class PanelMostrarEmpleado extends JPanel {
	...
	private void initGUI() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (id < 0) {
						...
						AplicationController.getInstance().handle(new Context(id, CommandEnum.MostrarEmpleado));
					}
		...
		textFieldID.setToolTipText("Insertar el identificador del empleado a consultar");
	...
	public void update(Context context) {
		...
		case MostrarEmpleadoCorrecto: {
			...
			contenedorDatos.setText(e.toString());
