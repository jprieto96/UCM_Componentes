 ...
 * 
 */
package presentacion.empleado.bajaEmpleado;
...
public class PanelBajaEmpleado extends JPanel {
	...
	private void initGUI() {
		...
		botonBaja = new JButton("Dar de baja empleado");
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (idCliente < 0) {
						...
						AplicationController.getInstance().handle(new Context(idCliente, CommandEnum.BajaEmpleado));
					}
	...
	public void update(Context context) {
		...
		case BajaEmpleadoFallo: {
			JOptionPane.showMessageDialog(null,
					"Error al intentar dar de baja al empleado: el empleado no existe o ya esta dado de baja", "Error",
