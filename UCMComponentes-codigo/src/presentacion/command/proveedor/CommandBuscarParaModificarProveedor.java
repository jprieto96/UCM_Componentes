...
public class CommandBuscarParaModificarProveedor implements Command {
	...
	public Context execute(Context context) {
		...
		c.setDato(proveedor);
		if (proveedor != null)
			c.setEvento(CommandEnum.BuscarParaModificarProveedorCorrecto);
		else
			c.setEvento(CommandEnum.BuscarParaModificarProveedorIncorrecto);
		return c;
	}
}